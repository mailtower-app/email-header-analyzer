  ...
  >
    ...
    >
      ...
      <path
        ...
        style="fill: #aaa; stroke: #888; stroke-width: 0.3"
      />
      <text x="4" y="20" style="font: bold 4px sans-serif; fill: #666">
        {{ received.byDomain }}
      </text>
      <text x="4" y="26" style="font: normal 4px sans-serif; fill: #666">
        {{ received.byIpAddress }}
      </text>

      <text x="4" y="32" style="font: normal 4px sans-serif; fill: #666">
        {{ received.with?.slice(0, 50) }}
      </text>
    </g>
  </svg>
</template>
